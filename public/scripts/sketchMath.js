...
//setup helper
 ...
 answerStrokeB = 3;
  ...
  myButton_color_erase = new Clickable();     //exit
...
//Haut
push();
stroke(answerColorR_H, 255, answerColorB_H);
strokeWeight(answerStrokeH);
scribble.scribbleRoundedRect( windowWidth/2, windowHeight/6, 155, 155, 50);
pop();
...
pop ();
	 ...
	 push();
	 translate(0, 0);
	 scribble.scribbleRoundedRect( windowWidth/2, windowHeight/2, windowHeight/1.6, windowHeight/3, 50);
...
function keyPressed() {
  ...
  helperSizeW = windowWidth;
  helperSizeH = windowHeight;
}
